...
<head>
    ...
    <title>Condomínio | Conta Bancária</title>
                    ...
                    <div class="ibox">
                      ...
                      <div class="ibox-content">
                          ...
                          <form class="" action="index.html" method="post">
                            <div class="row">
                                <div class="col-lg-12">
                                  <div class="form-group"><label>Nome Referência</label> <input type="text" name="unidade" id="unidade" class="form-control" required></div>
                                </div>

                                <div class="col-lg-12">
                                  <div class="form-group"><label>Banco</label> <input type="text" name="unidade" id="unidade" class="form-control" required></div>
                                </div>

                                <div class="col-lg-12">
                                  <div class="form-group"><label>Agência(Com digito)</label> <input type="text" name="unidade" id="unidade" class="form-control" required></div>
                                </div>

                                <div class="col-lg-12">
                                  <div class="form-group"><label>Conta(Com digito)</label> <input type="text" name="unidade" id="unidade" class="form-control" required></div>
                                </div>
                    ...
                    <div class="ibox ">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <span class="label label-warning-light float-right">1 Conta</span>
                               </div>
                        </div>
                        <div class="ibox-content">
                            ...
                            <div>
                                <div class="feed-activity-list">
                                    ...
                                    <div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="float-right">21.692,63</small>
                                            <strong>Conta Principal </strong> Banco: Banco do Brasil; Agência: 1588; Conta: 31015-8;  <br>
                                            <small class="text-muted">Data de abertura: 08/08/2018</small>
                                ...
                                <button class="btn btn-primary btn-block m-t"><i class="fa fa-plus"></i> Nova Conta Bancária</button>
